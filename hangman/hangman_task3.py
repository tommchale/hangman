    ...
    def check_letter(self, letter):
        ...
        for item in list(self.str):
            if letter == item:
                ...
                for key in self.word_guessed.keys():
                    if letter == key:
                        self.word_guessed.update({key: letter})

                print(self.word_guessed.values())
    ...
    def ask_letter(self):
        ...
        while self.num_lives > 0:
            ...
            if len(list(letter)) == 1:
                ...
                #  play_game(word_list)
Player1 = Hangman(['heelep', 'mememe', 'foggyeg'])
Player1.ask_letter()
# %%
